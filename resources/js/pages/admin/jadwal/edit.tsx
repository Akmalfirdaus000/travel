...
export default function JadwalEdit({ jadwal, rutes, armada }: JadwalEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        rute_id: jadwal.rute_id ? jadwal.rute_id.toString() : '',
        armada_id: jadwal.armada_id ? jadwal.armada_id.toString() : '',
        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6 max-w-2xl mx-auto w-full">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Edit Jadwal</h1>
                        <p className="text-muted-foreground">Perbarui informasi waktu keberangkatan atau armada.</p>
                    </div>
                </div>
